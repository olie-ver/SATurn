...
namespace SATurn {
    ...
    class SATSolver {
        public:
            ...
            const std::vector<bool>& getSolution() const;
        ...
        private:
            typedef std::pair<std::vector<int>, std::vector<size_t>> learn_pair;
            ...
            std::optional<std::vector<size_t>> mark_satisfied();
