...
However, with iterative DPLL, there isn't such as thing as a decision level anymore,
kind of. We do away with the recursive calls (obviously), and that leads us to 
having a decision \textit{trail} rather than decision \textit{levels}.
