...
namespace saturn {
    class satsolver {
        ...
        private:
            ...
            //data structures for "clause VSIDS"
            double activeInc = 1.0;
            double activeGrow = 1.05;
            std::vector<double> cActivity;
            std::vector<size_t> creationConflict;
            std::vector<size_t> lbds;
